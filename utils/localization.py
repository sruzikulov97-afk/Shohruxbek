...
TEXTS = {
    "uz": {
        ...
        "sklad_add_product": "➕ Mahsulot qo'shish",
        "sklad_status": "📦 Sklad Qoldig'i",
        "add_stock": "➕ Skladga qo'shish",
        "enter_stock_qty": "Qancha miqdorda mahsulot qo'shmoqchisiz (faqat raqam)?",
        "pending_products": "🕐 Kutayotgan mahsulotlar",
        "publish_btn": "✅ Sotuvga chiqarish",
        "publish_product": "📢 Sotuvga chiqarish",
        "no_pending": "✅ Hozircha sotuvga chiqarilmagan mahsulot yo'q.",
        "published_ok": "✅ Mahsulot sotuvga chiqarildi: <b>{}</b>",
        "sklad_panel_welcome": "📦 <b>Sklad paneli</b>\n\nYangi mahsulot qo'shing. Mahsulot qo'shilgach, Bosh Admin uni sotuvga chiqaradi.",
    ...
    "zh": {
        ...
        "cancel": "❌ 取消",
        "prod_new": "➕ 添加新产品",
        "sklad_add_product": "➕ 添加产品",
        "sklad_status": "📦 库存余额",
        "add_stock": "➕ 添加库存",
        "enter_stock_qty": "您想添加多少数量（仅限数字）？",
        "pending_products": "🕐 待上架产品",
        "publish_btn": "✅ 上架销售",
        "publish_product": "📢 上架销售",
        "no_pending": "✅ 目前没有待上架的产品。",
        "published_ok": "✅ 产品已上架: <b>{}</b>",
        "sklad_panel_welcome": "📦 <b>仓库面板</b>\n\n请添加新产品。添加后，管理员将其上架销售。",
